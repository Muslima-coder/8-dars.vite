...
function Technologies(){
    return(
        ...
        <div class=" mx-auto w-[1300px] flex flex-col gap-[54px] ">
            <div>
                <div class="px-[20px] flex justify-between mb-1">
                <Text extraClass={"!mb-0"} title={"Html"}/>
                <Text extraClass={"!mb-0"} title={"Advanced"}/>
                </div>
                <div className="w-full bg-[#1E293B] rounded-full h-[32px]">
                    <div class="html w-[70%]  rounded-full h-[32px]"></div>
                </div>
            </div>
        ...
        <div>
            ...
            <div>
                ...
                <div className="w-full bg-[#1E293B] rounded-full h-[32px]">
                    <div class="html w-[50%]  rounded-full h-[32px]"></div>
                </div>
            </div>
            ...
            <div>
                ...
                <div className="w-full bg-[#1E293B] rounded-full h-[32px]">
                    <div class="html w-[30%]  rounded-full h-[32px]"></div>
                </div>
            </div>
